...
from fastapi.responses import HTMLResponse # Para respuestas HTML
...
from pydantic import BaseModel, EmailStr # pydantic hace validaciones de datos
from typing import Optional # Para campos opcionales o nulos
